                   ...
                   border border-white/10 bg-[#0f0f0f] overflow-hidden`,children:[e.jsxs("div",{className:`flex items-center justify-between px-8 py-5
                       ...
                       hover:border-white/30 transition-colors`,children:e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M1 1l10 10M11 1L1 11",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})})})]}),e.jsx("div",{className:`px-8 py-6 overflow-y-auto max-h-[60vh]
                        ...
                        scrollbar-thumb-white/10`,children:e.jsx("pre",{className:`text-xs text-white/45 leading-relaxed
                          whitespace-pre-wrap font-sans`,children:o.content})})]})}):null}function I(){const[i,r]=c.useState(null),o=L(),s=y(),t=(l,n)=>{l.preventDefault();const m=n.indexOf("#"),a=m>=0?n.slice(m+1):"";if(a){if(s.pathname!=="/"){o("/"),setTimeout(()=>b(a),0);return}b(a)}};return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"relative bg-black border-t border-white/5 overflow-hidden",children:[e.jsx("div",{className:`absolute bottom-0 left-1/2 -translate-x-1/2
                        ...
                        blur-[120px] pointer-events-none`}),e.jsxs("div",{className:"relative z-10 max-w-7xl mx-auto px-6 md:px-12",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-12 py-16",children:[e.jsxs("div",{className:"md:col-span-2",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-5",children:[e.jsxs("div",{className:"relative w-8 h-8",children:[e.jsx("div",{className:"absolute inset-0 rounded-full border border-gold-500/60"}),e.jsx("div",{className:"absolute inset-[5px] rounded-full bg-gold-500/20"}),e.jsx("div",{className:"absolute inset-[9px] rounded-full bg-gold-500"})]}),e.jsxs("span",{className:"font-display font-bold text-lg tracking-tight text-white",children:["Sennin",e.jsx("span",{className:"text-gold-gradient",children:"Web"})]})]}),e.jsx("p",{className:"text-sm text-white/35 leading-relaxed max-w-xs mb-6",children:"İşletmeleriniz için premium web tasarım ve SEO ajansı. Dijitalde güçlü bir varlık için buradayız."}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("a",{href:"mailto:macarcagatay@gmail.com",className:`flex items-center gap-2.5 text-xs text-white/35
                             hover:text-gold-400 transition-colors duration-300 group`,children:[e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 13 13",fill:"none",className:"text-gold-500/50 group-hover:text-gold-400 transition-colors",children:e.jsx("path",{d:"M1.5 3l5 4 5-4M1.5 3h10v8a.5.5 0 01-.5.5h-9a.5.5 0 01-.5-.5V3z",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round",strokeLinejoin:"round"})}),"macarcagatay@gmail.com"]}),e.jsxs("div",{className:"flex items-center gap-2.5 text-xs text-white/35",children:[e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 13 13",fill:"none",className:"text-gold-500/50",children:e.jsx("path",{d:"M6.5 1a4 4 0 100 8A4 4 0 006.5 1zM1 12c0-2 2.5-3 5.5-3s5.5 1 5.5 3",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"})}),"Bilecik & İstanbul, Türkiye"]})]})]}),S.map(l=>e.jsxs("div",{children:[e.jsx("h4",{className:`text-[10px] font-semibold uppercase tracking-[0.2em]
                               text-white/25 mb-5`,children:l.title}),e.jsx("ul",{className:"space-y-3",children:l.links.map(n=>e.jsx("li",{children:e.jsx("a",{href:n.href,onClick:m=>t(m,n.href),className:`text-sm text-white/40 hover:text-white
                                   transition-colors duration-300`,children:n.label})},n.label))})]},l.title))]}),e.jsx("div",{className:"gold-line opacity-10"}),e.jsxs("div",{className:`py-6 flex flex-col sm:flex-row items-center
                          justify-between gap-4`,children:[e.jsx("p",{className:"text-xs text-white/20 tracking-wide",children:"© 2025 SenninWeb. Tüm hakları saklıdır."}),e.jsx("div",{className:"flex items-center gap-6",children:[{key:"kvkk",label:"KVKK"},{key:"gizlilik",label:"Gizlilik Politikası"},{key:"kullanim",label:"Kullanım Koşulları"}].map(l=>e.jsx("button",{onClick:()=>r(l.key),className:`text-xs text-white/25 hover:text-white/60
                             transition-colors duration-300 underline
                             underline-offset-2 decoration-white/10`,children:l.label},l.key))})]})]})]}),e.jsx(A,{children:i&&e.jsx(C,{type:i,onClose:()=>r(null)})})]})}function W({routeKey:i}){const r=c.useRef(null),o=c.useRef(null),s=c.useRef(new Set),t=c.useRef(null),l=z(-100),n=z(-100),m=g(l,{stiffness:80,damping:20,mass:.5}),a=g(n,{stiffness:80,damping:20,mass:.5}),h=g(l,{stiffness:400,damping:28,mass:.2}),f=g(n,{stiffness:400,damping:28,mass:.2});return c.useEffect(()=>{const d=x=>{l.set(x.clientX),n.set(x.clientY)};return window.addEventListener("mousemove",d,{passive:!0}),()=>{window.removeEventListener("mousemove",d)}},[]),c.useEffect(()=>{const d=()=>{r.current&&r.current.classList.add("scale-[2.5]","border-gold-500","opacity-60")},x=()=>{r.current&&r.current.classList.remove("scale-[2.5]","border-gold-500","opacity-60")},p=k=>{s.current.has(k.target)&&d()},v=k=>{s.current.has(k.target)&&x()};return(()=>{t.current&&(document.removeEventListener("mouseenter",p,!0),document.removeEventListener("mouseleave",v,!0));const k=document.querySelectorAll('a, button, [role="button"], [data-cursor]');s.current.clear(),k.forEach(E=>{s.current.add(E)}),document.addEventListener("mouseenter",p,!0),document.addEventListener("mouseleave",v,!0),t.current={handleMouseEnter:p,handleMouseLeave:v}})(),()=>{t.current&&(document.removeEventListener("mouseenter",p,!0),document.removeEventListener("mouseleave",v,!0))}},[i]),e.jsxs(e.Fragment,{children:[e.jsx(u.div,{ref:r,className:"fixed top-0 left-0 w-9 h-9 rounded-full border border-white/30 pointer-events-none z-[9999] transition-transform duration-200",style:{x:m,y:a,translateX:"-50%",translateY:"-50%"}}),e.jsx(u.div,{ref:o,className:"fixed top-0 left-0 w-1.5 h-1.5 rounded-full bg-gold-500 pointer-events-none z-[9999]",style:{x:h,y:f,translateX:"-50%",translateY:"-50%"}})]})}function N(){return!(typeof window>"u"||window.innerWidth<=768||window.matchMedia&&window.matchMedia("(pointer: fine)").matches===!1||window.matchMedia&&window.matchMedia("(hover: hover)").matches===!1)}function B(){const i=y(),[r,o]=c.useState(N);c.useEffect(()=>{const t=()=>o(N());t(),window.addEventListener("resize",t);const l=window.matchMedia?.("(pointer: fine)"),n=window.matchMedia?.("(hover: hover)");return l?.addEventListener?.("change",t),n?.addEventListener?.("change",t),()=>{window.removeEventListener("resize",t),l?.removeEventListener?.("change",t),n?.removeEventListener?.("change",t)}},[]),c.useEffect(()=>{if(!(typeof document>"u"))return document.body.classList.toggle("cursor-none",r),()=>{document.body.classList.remove("cursor-none")}},[r]),c.useEffect(()=>{if(typeof window>"u"||i.pathname!=="/"||!i.hash)return;const t=i.hash.startsWith("#")?i.hash.slice(1):i.hash;t&&setTimeout(()=>b(t),0)},[i.pathname,i.hash]);const s=c.useMemo(()=>`${i.pathname}${i.search}${i.hash}`,[i.pathname,i.search,i.hash]);return e.jsxs(e.Fragment,{children:[r&&e.jsx(W,{routeKey:s}),e.jsx(M,{}),e.jsxs("div",{className:"min-h-screen flex flex-col bg-black text-white",children:[e.jsx("main",{className:"flex-1 pt-28",children:e.jsx(R,{})}),e.jsx(I,{})]})]})}export{B as L,b as s};
