export const blogPosts = [
  {
    ...
    title: "Küçük İşletmeler İçin Web Sitesi Nasıl Müşteri Getirir? | SenninWeb",
    description: "Küçük işletmeler için web sitesinin nasıl müşteri getirdiğini öğrenin. SEO, hız ve doğru strateji ile daha fazla müşteri kazanın.",
    shortTitle: "Küçük İşletmeler İçin Web Sitesi Nasıl Müşteri Getirir?",
    ...
    sections: [
      {
        type: "intro",
        content: "Günümüzde bir işletmenin başarılı olabilmesi için sadece fiziksel bir mağazaya sahip olması yeterli değil. İnsanlar bir ürün veya hizmet aradığında ilk yaptıkları şey Google'da arama yapmak. Eğer işletmeniz bu aramalarda görünmüyorsa, potansiyel müşterilerinizi fark etmeden kaybediyorsunuz demektir."
      },
      {
        type: "question",
        question: "Peki bir web sitesi gerçekten müşteri getirir mi?",
        answer: "Evet, ama doğru yapılırsa."
      },
      {
        type: "paragraph",
      ...
      {
        type: "section",
        heading: "3 Temel Başlık",
        content: "Gerçekten müşteri getiren bir web sitesi 3 temel üzerine kuruludur:",
        subsections: [
          {
            heading: "1. Google'da Görünürlük (SEO)",
            content: "İnsanlar hizmet ararken sizin sitenizi bulabilmeli. Bunun için doğru anahtar kelimeler, teknik SEO ve içerik stratejisi gerekir."
          },
          {
          ...
          },
          {
            ...
            content: "Kullanıcı siteye geldiğinde ne yapacağını bilmeli. \"Teklif al\", \"iletişime geç\" gibi yönlendirmeler olmadan ziyaretçiler müşteriye dönüşmez."
          }
        ]
      },
      {
        type: "paragraph",
        content: "Profesyonel bir web sitesi sizin için 7/24 çalışan bir satış temsilcisi gibidir. Doğru kurulduğunda size sürekli yeni müşteriler kazandırır."
      },
      {
        type: "conclusion",
        intro: "Eğer sizin de web siteniz:",
        items: [
          "müşteri getirmiyorsa",
          "Google'da görünmüyorsa",
          "yavaş çalışıyorsa"
        ],
        closing: "bunun çözümü doğru bir strateji ile mümkündür."
      },
      {
        type: "finalParagraph",
        content: "İşletmenize özel, hızlı ve SEO uyumlu bir web sitesi ile dijitalde rakiplerinizin önüne geçebilirsiniz."
      }
    ]
  },
  {
    slug: "kucuk-isletmeler-icin-web-sitesi-nasil-musteri-getirir",
    title: "Küçük İşletmeler İçin Web Sitesi Nasıl Müşteri Getirir? | 2026 SEO Rehberi | SenninWeb",
    description: "Web siteniz var ama müşteri gelmiyor mu? 2026 SEO, Google Maps ve kurumsal web tasarımı stratejileriyle dijitalde nasıl öne çıkacağınızı ve satışlarınızı nasıl artıracağınızı öğrenin.",
    shortTitle: "Küçük İşletmeler İçin Web Sitesi Nasıl Müşteri Getirir? | 2026 SEO Rehberi",
    desc: "2026 yılında müşteri getiren web sitesinin sırları - SEO, Google Maps ve kurumsal tasarım.",
    tag: "SEO & Büyüme",
    readingTime: "12 dk",
    date: "2026",
    author: "Çağatay Macar",
    ...
    sections: [
      {
        type: "heroSection",
        title: "Küçük İşletmeler İçin Web Sitesi Nasıl Gerçek Bir Müşteri Mıknatısına Dönüşür? (2026 Güncel Rehber)",
        subtitle: "Giriş: Tabelasız Dükkanın Dijital Çilesi"
      },
      {
        type: "paragraph",
        content: "Şöyle bir düşünün: İstanbul'un en kalabalık caddelerinden birinde harika bir dükkan açtınız. İçerideki ürünleriniz kaliteli, fiyatlarınız uygun, hizmetiniz kusursuz. Ancak küçük bir sorun var; dükkanın tabelası yok, vitrin camları simsiyah boyanmış ve Google Haritalar'da konumunuz görünmüyor."
      },
      {
        type: "paragraph",
        content: "Sokaktan her gün binlerce kişi geçiyor ama kimse sizin orada olduğunuzu bilmiyor."
      },
      {
        type: "paragraph",
        content: "Bugün, profesyonel bir web sitesi olmayan veya sitesi Google'da görünmeyen küçük işletmelerin durumu tam olarak budur. İnternet deneyimlerinin %93'ü bir arama motoruyla başlıyor. Yani potansiyel müşterileriniz bir hizmete ihtiyaç duyduğunda ilk iş telefonuna sarılıyor."
      },
      {
        type: "paragraph",
        content: "Eğer o ekranda yoksanız, o müşteri için aslında yoksunuz demektir."
      },
      {
        type: "paragraph",
        content: "Peki, sadece bir \"web sitesi yaptırmak\" yeterli mi? Neden bazı siteler telefonları susturmazken diğerleri dijital birer tozlu rafa dönüşüyor?"
      },
      {
        type: "paragraph",
        content: "Gelin, web sitenizi pasif bir masraftan, 7/24 çalışan bir satış makinesine dönüştürmenin sırlarını birlikte çözelim."
      },
      {
        type: "heading2",
        content: "1. Web Sitem Var Ama Müşteri Gelmiyor: Nerede Hata Yapıyoruz?"
      },
      {
        type: "paragraph",
        content: "Birçok işletme sahibi, \"Web sitesi kurduk ama tık yok\" diyerek dijital dünyaya küsüyor. Ancak gerçek şu ki; satış getiren bir web sitesi sadece bir vitrin değil, yaşayan bir sistemdir."
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading2",
        content: "2. Müşteri Çeken Bir Web Sitenin 3 Altın Kuralı"
      },
      {
        type: "paragraph",
        content: "Web sitenizin bir \"müşteri mıknatısı\" gibi çalışması için şu üç sütun üzerine inşa edilmesi şarttır:"
      },
      {
        type: "heading3",
        content: "A. Doğru Mesaj ve İkna (Copywriting)"
      },
      {
        type: "paragraph",
        content: "Sitenizin metinleri bir satış temsilcisi gibi konuşmalıdır. 2026 SEO trendleri artık sadece anahtar kelimelere değil, \"kullanıcı niyetine\" (search intent) odaklanıyor."
      },
      {
        type: "paragraph",
        content: "İnsanlar \"en iyi tesisatçı\" yazısını her yerde görüyor. Sizin farkınız ne?"
      },
      {
        type: "paragraph",
        content: "\"30 dakikada kapınızdayız ve 2 yıl garantili tamir yapıyoruz\" cümlesi, sadece bilgi değil, çözüm ve güven satar."
      },
      {
        type: "heading3",
        content: "B. Google'da Görünürlük (SEO'nun Gücü)"
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        content: "Doğru anahtar kelime araştırması ve içerik optimizasyonu ile tam da sizin hizmetinizi arayan \"sıcak müşterilere\" reklam bütçesi harcamadan ulaşırsınız."
      },
      {
        type: "heading3",
        content: "C. Güven İnşası (Marka Algısı)"
      },
      {
        type: "paragraph",
        content: "Dijital dünyada güven, paranın birimidir."
      },
      {
        type: "bulletList",
        items: [
      ...
      {
        type: "heading2",
        content: "3. Gizli Silah: Google Maps ve Yerel SEO"
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading2",
        content: "4. İyi Bir Web Sitesi vs. Kötü Bir Web Sitesi"
      },
      {
        type: "heading3",
        content: "Kötü Web Sitesi:"
      },
      {
        type: "bulletList",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          "HTTPS güvenliği",
          "Gerçek ve kaliteli görseller"
        ]
      },
      {
        type: "heading2",
        content: "5. Küçük İşletmelerin Yaptığı En Büyük 5 Hata"
      },
      {
        type: "bulletList",
        items: [
          "Mobil deneyimi önemsememek",
          "Google Maps'i ihmal etmek",
          "İçerik üretmemek",
          "SSL kullanmamak",
          "İletişimi zorlaştırmak"
        ]
      },
      {
        type: "heading2",
        content: "6. Bugün Atabileceğiniz 3 Somut Adım"
      },
      {
        type: "bulletList",
        items: [
          "Sitenizi test edin: Google PageSpeed Insights ile hız kontrolü yap",
          "Maps profilini güncelle: 5 kaliteli fotoğraf ekle",
          "Mesajını netleştir: İlk cümlede değer önerini anlat"
        ]
      },
      {
        type: "heading2",
        content: "Sonuç: Yarının Kazananı Dijitalde Yerini Alanlar Olacak"
      },
      {
        type: "paragraph",
        content: "2026 perspektifinden baktığımızda, dijitalleşme artık bir tercih değil, sürdürülebilir büyümenin anahtarıdır."
      },
      {
        type: "paragraph",
        content: "Türkiye'de KOBİ'lerin %65'i hala manuel süreçlerle uğraşırken, profesyonel bir web sitesi ve doğru bir SEO stratejisiyle öne çıkan işletmeler ciddi bir rekabet avantajı elde ediyor."
      },
      {
        type: "paragraph",
        content: "Siz de rakiplerinizin önüne geçmek, Google'da tam da arandığınız anda müşterilerinizin karşısına çıkmak ve web sitenizi gerçek bir satış ofisine dönüştürmek istemez misiniz?"
      },
      {
        type: "finalCta",
        question: "İşletmenizin dijital potansiyelini keşfetmeye hazır mısınız?",
  ...
  {
    slug: "tasarimin-5-temel-ilkesi",
    title: "Tasarımın 5 Temel İlkesi: Kurumsal Web Tasarımında Profesyonel Farkı | SenninWeb",
    description: "Kurumsal web tasarımın 5 temel ilkesini öğrenin. Müşteri ihtiyaçlarından SEO'ya, profesyonel web tasarımda fark yaratan adımları keşfedin.",
    shortTitle: "Tasarımın 5 Temel İlkesi: Kurumsal Web Tasarım Rehberi",
    desc: "Kurumsal ve profesyonel web tasarımın 5 temel ilkesi ile sitenizi bir üst seviyeye taşıyın.",
    tag: "Web Tasarım",
    readingTime: "10 dk",
    date: "2026",
    author: "Çağatay Macar",
    authorTitle: "Senior Web Developer",
    metaDescription: "Kurumsal web tasarımın 5 temel ilkesini öğrenin. Müşteri ihtiyaçları, UI/UX, hız, mobil uyum ve SEO ile profesyonel web tasarımda fark yaratın.",
    schemaUrl: "https://www.senninweb.com/blog/tasarimin-5-temel-ilkesi",
    sections: [
      {
        type: "intro",
        content: "Web tasarım dendiğinde çoğu kişinin aklına ilk gelen şey görselliktir. \"Şu site ne kadar güzelmiş\", \"bu site biraz amatör duruyor\" gibi cümleler kurarız. Oysa profesyonel bir web sitesini güzel yapan şey sadece renkler veya fontlar değildir. İyi bir web tasarımı, perde arkasında onlarca kararın verildiği, stratejik düşünülmüş bir sürecin sonucudur. Kurumsal web tasarım dediğimiz şey tam olarak budur — görselin ötesinde, iş hedeflerine hizmet eden bir yapı kurmak."
      },
      {
        type: "question",
        question: "Peki profesyonel bir web sitesini 'profesyonel' yapan şey nedir?",
        answer: "Bir değil, beş temel ilke vardır. Bunlardan biri eksik olduğunda site ya güzel durur ama çalışmaz, ya çalışır ama kimse bulamaz, ya da bulunur ama kimse kullanamaz."
      },
      {
        type: "paragraph",
        content: "Yıllardır web tasarım ve SEO hizmeti veren biri olarak şunu rahatlıkla söyleyebilirim: web sitesi firmaları arasındaki en büyük fark, bu ilkelerin kaçını gerçekten uyguladıklarıdır. Hadi gelin, bir profesyonel web tasarım sürecini ayakta tutan 5 temel ilkeye yakından bakalım."
      },
      {
        type: "section",
        heading: "Kurumsal Web Tasarımın 5 Temel İlkesi",
        content: "Her biri birbirini tamamlayan bu beş ilke, sıfırdan bir site kurarken veya mevcut bir siteyi iyileştirirken takip edilmesi gereken yol haritasıdır.",
        subsections: [
          {
            heading: "1. Müşteri İhtiyaçlarının Belirlenmesi",
            content: "Geçenlerde gayrimenkul danışmanı Mahir Akar Bey ile konuşuyorduk. Kendisine baştan sona bir web sitesi yapmadım — zaten bir sitesi vardı. Ona local SEO hizmeti veriyorum. Birlikte oturup hedef anahtar kelimeleri belirledik, içerikleri için en çok aratılan sorulardan başlıklar ürettik. Ayrıca sitesine blog sayfaları ekledik, hız ve erişilebilirlik konusunda gerekli düzeltmeleri yaptım. İşte bu süreç, bir web sitesinin sadece yapılıp bırakılacak bir şey olmadığını gösteriyor. Müşteri ihtiyaçları dediğimiz şey, bir kere konuşup biten bir şey değildir — sürekli güncellenen, gelişen bir süreçtir. Kısacası, bir web sitesi yapmaya karar verdiğinizde ilk yapmanız gereken şey bir aynanın karşısına geçip kendinize şu soruyu sormaktır: 'Bu site benim için ne yapacak?' Kurumsal web tasarım süreci bu soruyla başlar. Hedef kitlenizi tanımadan, onların ihtiyaçlarını anlamadan yapılmış bir site, ne kadar gösterişli olursa olsun boş bir vitrinden farksızdır."
          },
          {
            heading: "2. Görsel Hiyerarşi ve Kullanıcı Deneyimi (UI/UX)",
            content: "Bir siteye girdiğinizde gözünüzün ilk nereye gittiğini hiç fark ettiniz mi? İşte bu, görsel hiyerarşi denen şeyin ta kendisidir. Profesyonel web tasarım, kullanıcının gözünü yormadan, onu istediğiniz yöne nazikçe yönlendirme sanatıdır. Büyük başlıklar, kontrast renkler, doğru boşluk kullanımı — bunların hepsi kullanıcıya 'Önce buraya bak, sonra şuraya tıkla' mesajı verir. Kullanıcı deneyimi (UX) ise bunun bir adım ötesidir: butonların boyutu, menünün konumu, yazı büyüklüğü... Bunları doğru ayarlamazsanız siteniz ne kadar güzel olursa olsun, ziyaretçileriniz bir süre sonra 'ya tamam da nereye tıklayacağım şimdi ben' diyerek siteden çıkar."
          },
          {
            heading: "3. Hız ve Performans Optimizasyonu",
            content: "Bu maddeyi atlayan web sitesi firmaları maalesef ki bir numaralı hatayı yapıyor. İnsanlar sabırsız. Bir sitenin açılmasını 3 saniyeden fazla bekleyen kullanıcıların neredeyse yarısı sayfayı terk ediyor. Hız, sadece kullanıcı memnuniyeti için değil, Google sıralamaları için de kritik. Core Web Vitals dediğimiz performans metrikleri, artık Google'ın sıralama faktörleri arasında. Yani siteniz yavaşsa, Google da onu aşağılara atıyor. Görsel optimizasyonu, gereksiz kod temizliği, önbellekleme ve CDN kullanımı gibi teknik detaylar kulak tırmalayabilir belki, ama bir profesyonel web tasarım sürecinde bunların hepsi hesaba katılmalı."
          },
          {
            heading: "4. Mobil Uyumluluk (Responsive Design)",
            content: "Günümüzde internet trafiğinin yüzde 60'ından fazlası mobil cihazlardan geliyor. Bu demek oluyor ki siteniz masaüstünde mükemmel görünse bile, telefonda açıldığında dağınık duruyorsa potansiyel müşterilerinizin çoğunu kaybediyorsunuz. Responsive design, sitenizin her ekran boyutuna otomatik olarak uyum sağlaması demek. Eskiden ayrı bir mobil site yapma dönemi vardı, artık öyle değil. Google, mobil-first indexing dediği bir sistemle önce sitenizin mobil sürümüne bakıyor, onu değerlendiriyor. Kurumsal web tasarım yaptırırken 'mobilde nasıl görünecek?' sorusu en başta sorulması gereken sorulardan biridir."
          },
          {
            heading: "5. SEO ve Dijital Görünürlük",
            content: "Sonuncuyu en önemli madde olarak sakladım diyebilirim. Çünkü siteniz ne kadar güzel, hızlı ve mobil uyumlu olursa olsun, Google'da görünmüyorsa bir anlamı yok. SEO (arama motoru optimizasyonu), sitenizin Google'da üst sıralarda çıkması için yapılan çalışmaların bütünüdür. Web sitesi firmaları arasında seçim yaparken size sadece 'site yaparız' değil, 'sitenizi Google'da da gösteririz' diyenleri tercih etmelisiniz. Doğru anahtar kelime stratejisi, meta etiketler, hızlı yükleme süreleri ve kaliteli içerik — bunların hepsi SEO'nun bir parçası. Ayrıca son yıllarda AEO (Answer Engine Optimization) ve GEO (Generative Engine Optimization) gibi kavramlar da ortaya çıktı. Bunları da duymaya başlayacaksınız, emin olun."
          }
        ]
      },
      {
        type: "conclusion",
        intro: "Özetlemek gerekirse, bir web sitesini profesyonel yapan şey sadece görselliği değil, aynı anda birden fazla katmanda doğru kararlar verilmiş olmasıdır. Eğer siteniz:",
        items: [
          "müşteri ihtiyaçlarına göre şekillenmemişse",
          "kullanıcı dostu değilse",
          "yavaş açılıyorsa",
          "mobilde dağılıyorsa",
          "Google'da görünmüyorsa"
        ],
        closing: "bunların hepsinin bir çözümü var. Ama önce sorunu kabul etmek gerek."
      },
      {
        type: "finalCta",
        question: "İşletmenize özel, bu 5 ilkeye uygun bir web sitesi mi arıyorsunuz?",
        ctaText: "Bizimle iletişime geçin, size özel bir strateji oluşturalım!"
      }
    ]
  }
