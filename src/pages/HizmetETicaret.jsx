...
const content = {
  ...
  description: "İşletmenizi 7/24 satış yapacak şekilde dijital dönüşüme hazırlıyoruz. Ödeme entegrasyonlu, SEO uyumlu ve mobil dostu e-ticaret siteleri kuruyoruz.",
  sections: [
    {
      type: "heroSection",
