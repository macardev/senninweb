...
export default function Hakkimizda() {
  ...
  useEffect(() => {
    ...
    document.title = "Hakkımızda: SenninWeb Web Tasarım & SEO Ajansı"
    upsertMetaByName("description", "SenninWeb'i tanıyın: KOBİ'ler için premium web tasarım ve SEO çözümleri üreten butik ajans. Çalışma sürecimizi keşfedin, ücretsiz teklif alın.")
    upsertMetaByName("robots", "index, follow")

    upsertMetaByProperty("og:title", "Hakkımızda: SenninWeb Web Tasarım & SEO Ajansı")
    upsertMetaByProperty("og:description", "SenninWeb'i tanıyın: KOBİ'ler için premium web tasarım ve SEO çözümleri üreten butik ajans. Çalışma sürecimizi keşfedin, ücretsiz teklif alın.")
    ...
    upsertMetaByName("twitter:title", "Hakkımızda: SenninWeb Web Tasarım & SEO Ajansı")
    upsertMetaByName("twitter:description", "SenninWeb'i tanıyın: KOBİ'ler için premium web tasarım ve SEO çözümleri üreten butik ajans. Çalışma sürecimizi keşfedin, ücretsiz teklif alın.")
