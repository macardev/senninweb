...
export default function Hero() {
  ...
  const delay = (i) => `${isMobile ? 0.03 : 0.08 * i}s`
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
        <div className="max-w-2xl">
          ...
          <div
            ...
            style={{ transitionDelay: isMobile ? '0.05s' : '0.1s' }}
          >
          ...
          <div
            ...
            style={{ transitionDelay: isMobile ? '0.1s' : '0.2s' }}
          >
            <p className="text-base md:text-lg text-white/50 leading-relaxed mb-10 max-w-lg break-words overflow-wrap-break-word max-w-full">
          ...
          <div
            ...
            style={{ transitionDelay: isMobile ? '0.15s' : '0.3s' }}
          >
            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 sm:gap-4 max-w-full overflow-hidden">
              <button
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-2.5 px-8 sm:px-10 py-4 sm:py-5 rounded-full border border-white/20 hover:border-white/40 text-base font-medium text-white/70 hover:text-white transition-all duration-200 group cursor-pointer hover:scale-[1.03] active:scale-[0.97]"
              >
          ...
          <div
            ...
            style={{ transitionDelay: isMobile ? '0.2s' : '0.4s' }}
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-16 pt-8 border-t border-white/8 max-w-full overflow-hidden">
              {[
