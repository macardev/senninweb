...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    setSending(false)
    alert('Bir hata oluştu. Lütfen doğrudan business@senninweb.com adresine yazın.')
  }
}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
              ...
              {[
                {
                  ...
                  label: 'E-posta',
                  value: 'business@senninweb.com',
                  href:  'mailto:business@senninweb.com',
                },
                {
                  icon: (
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <div
              className={`w-full h-48 md:h-56 mt-8 rounded-2xl overflow-hidden border border-white/8 transition-all duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
                inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[30px]'
              }`}
            ...
            >
              {inView && (
                <iframe
                  ...
                  title="Sennin Web Konum"
                />
              )}
            </div>

            <div
              className={`inline-flex items-center gap-3 mt-8 px-5 py-3
            ...
            {sent ? (
              ...
              >
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  En kısa sürede business@senninweb.com
              ...
              <a
                ...
                className="group block w-full mb-8 p-[1px] rounded-2xl
                           bg-gradient-to-br from-[#25D366] via-[#22C55E] to-[#16A34A]
                           shadow-[0_0_30px_rgba(37,211,102,0.25)]
                           hover:shadow-[0_0_60px_rgba(37,211,102,0.45)]
                           hover:scale-[1.02] transition-all duration-300
                           animate-pulse"
              >
                <div className="w-full h-full rounded-[calc(1rem-1px)]
                                bg-gradient-to-br from-[#25D366] via-[#22C55E] to-[#16A34A]
                                px-6 py-5 flex flex-col items-center justify-center gap-1">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white font-bold text-lg">
                      Stratejinizi hemen planlayalım
                    </span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-white/80 group-hover:translate-x-1 transition-transform">
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    ...
                    <span className="text-white/90 text-sm font-medium">
                      Ortalama 5 dakika içinde yanıtlıyoruz
                    </span>
                  </div>
                </div>
              </a>
